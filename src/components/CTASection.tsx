    ...
    <section className="relative py-24 md:py-32 paper-texture overflow-hidden">
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="font-body text-sm text-muted-foreground/70 mb-12">
            Powered by Solana Devnet • Open Source • Community Driven
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {[
              { label: "Register Farmer", icon: "🌱" },
              { label: "Become Retailer", icon: "🏪" },
              { label: "Track Produce", icon: "📍" },
            ].map((btn, i) => (
              <motion.button
                key={btn.label}
